...
export const metadata: Metadata = {
  ...
  description: 'AI tools like Bolt.new and Lovable are disrupting Wix. But will websites get cheaper? An honest analysis from a Taranaki developer on AI vs human developers.',
  keywords: ['AI website builders', 'Bolt.new', 'Lovable', 'AI web design', 'web design cost 2025', 'Taranaki web developer', 'New Plymouth web developer', 'Wix alternative'],
  alternates: {
